...
No. The install script downloads a prebuilt binary. Go is only needed if you prefer `go install github.com/karlssonsimon/lazyaz/cmd/lazyaz@latest` (requires Go 1.22+).
