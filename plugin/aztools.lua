...
local function set_highlights()
  ...
  vim.api.nvim_set_hl(0, "AztoolsBorderDlq", { link = "DiagnosticError", default = true })
  vim.api.nvim_set_hl(0, "AztoolsTitleDlq", { link = "DiagnosticError", default = true })
  vim.api.nvim_set_hl(0, "AztoolsDangerText", { link = "DiagnosticError", default = true })
