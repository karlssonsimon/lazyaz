...
func Default() Keymap {
	return Keymap{
		...
		FullPageDown:        New("ctrl+f"),
		FullPageUp:          New("ctrl+b"),
		ScrollLineDown:      New("ctrl+e"),
		ScrollLineUp:        New("ctrl+y"),
		ScrollPrefix:        New("z"),
		ScrollCenter:        New("z"),
		ScrollTop:           New("t"),
		ScrollBottom:        New("b"),
		...
		SearchNext:          New("n"),
		SearchPrev:          New("N"),
		MotionLeft:          New("h", "left"),
		MotionRight:         New("l", "right"),
		MotionWordForward:   New("w"),
		MotionWordBack:      New("b"),
		MotionWordEnd:       New("e"),
		MotionLineStart:     New("0"),
		MotionLineEnd:       New("$"),
		FindChar:            New("f"),
		FindCharBack:        New("F"),
		TillChar:            New("t"),
		...
		PreviewYank:         New("y"),
		MotionBigWord:       New("W"),
		MotionBigWordBack:   New("B"),
		MotionBigWordEnd:    New("E"),
		ObjectInner:         New("i"),
		ObjectAround:        New("a"),
